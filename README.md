...
This repository contains the conceptual definition and theoretical framework for **Demonstrating VEGA Node Network**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── demonstrating-vega-node-network.tex    # LaTeX dissertation
├── whitepaper/
│   └── demonstrating-vega-node-network.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025demonstratingveganodenetwork,
  author = {Vega, Adam Eren},
  title = {Demonstrating VEGA Node Network: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/demonstrating-vega-node-network}
}
```
